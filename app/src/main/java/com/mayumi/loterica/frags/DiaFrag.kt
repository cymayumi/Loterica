...
import kotlinx.android.synthetic.main.dia_fragment.tv_1
import kotlinx.android.synthetic.main.dia_fragment.tv_2
import kotlinx.android.synthetic.main.dia_fragment.tv_3
import kotlinx.android.synthetic.main.dia_fragment.tv_4
import kotlinx.android.synthetic.main.dia_fragment.tv_5
import kotlinx.android.synthetic.main.dia_fragment.tv_6
import kotlinx.android.synthetic.main.dia_fragment.tv_cidade_concurso
import kotlinx.android.synthetic.main.dia_fragment.tv_num_concurso
import kotlinx.android.synthetic.main.dia_fragment.tv_valor_proximo
    ...
    private fun resultadoDia() {
        uiScope.launch {
            val response = withContext(Dispatchers.IO) {
                ...
                return@withContext destinationService.resultDia()
            }
            ...
            if (response.isSuccessful) {
                ...
                tv_mes.text = result.nome_mes_sorte
                ...
                tv_ganhadores_mes.text = result.premiacao[4].quantidade_ganhadores
                ...
                tv_valor_mes.text = result.premiacao[4].valor_total
